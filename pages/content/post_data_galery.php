...
<div class="container">
	...
	<div class="page-header">
    	<a class="btn btn-danger" href="session.php?p=post_galery"> <span class="glyphicon glyphicon-eye-open"></span> Back </a>    Batamolehlo 
		<a class="btn btn-success" href="session.php?p=post_data_galery"> <span class="glyphicon glyphicon-eye-open"></span> Tambah Lagi </a>
    </div>
...
<input class="form-control" type="hidden" name="kategori" placeholder=" " value="galery" required />
